...
#find_package(Qt5Core ${REQUIRED_QT_VERSION} PATHS "/opt/qt59/lib/cmake" "~/QtCreator/latest/lib/Qt/lib/" NO_DEFAULT_PATH)
#find_package(Qt5DBus ${REQUIRED_QT_VERSION} PATHS "/opt/qt59/lib/cmake" "~/QtCreator/latest/lib/Qt/lib/" NO_DEFAULT_PATH)
#find_package(Qt5Gui ${REQUIRED_QT_VERSION} PATHS "/opt/qt59/lib/cmake" "~/QtCreator/latest/lib/Qt/lib/" NO_DEFAULT_PATH)
#find_package(Qt5Qml ${REQUIRED_QT_VERSION} PATHS "/opt/qt59/lib/cmake" "~/QtCreator/latest/lib/Qt/lib/" NO_DEFAULT_PATH)
#find_package(Qt5Quick ${REQUIRED_QT_VERSION} PATHS "/opt/qt59/lib/cmake" "~/QtCreator/latest/lib/Qt/lib/" NO_DEFAULT_PATH)
#find_package(Qt5Test ${REQUIRED_QT_VERSION} PATHS "/opt/qt59/lib/cmake" "~/QtCreator/latest/lib/Qt/lib/" NO_DEFAULT_PATH)
#find_package(Qt5Widgets ${REQUIRED_QT_VERSION} PATHS "/opt/qt59/lib/cmake" "~/QtCreator/latest/lib/Qt/lib/" NO_DEFAULT_PATH)
#find_package(Qt5Network ${REQUIRED_QT_VERSION} PATHS "/opt/qt59/lib/cmake" "~/QtCreator/latest/lib/Qt/lib/" NO_DEFAULT_PATH)
#find_package(Qt5Xml ${REQUIRED_QT_VERSION} PATHS "/opt/qt59/lib/cmake" "~/QtCreator/latest/lib/Qt/lib/" NO_DEFAULT_PATH)
